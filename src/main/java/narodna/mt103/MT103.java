...
public class MT103 {
    ...
    public MT103(String idPoruke, String swifKodBankeDuznika, String obracunskiRacunBankeDuznika,
			String swiftKodBankePoverioca, String obracunskiRacunBankePoverioca, String duznik, String svrhaPlacanja,
			String primalac, Date datumNaloga, Date datumValute, String racunDuznika, BigInteger modelZaduzenja,
			String pozivNaBrojZaduzenja, String racunPoverioca, BigInteger modelOdobrenja, String pozivNaBrojOdobrenja,
			BigDecimal iznos, String sifraValute) {
		super();
