 ...
 * generated in the paket.mt102 package. 
...
public class ObjectFactory {
    ...
    private final static QName _PojedinacnoPlacanjeMT102_QNAME = new QName("http://paket/mt102", "pojedinacnoPlacanjeMT102");
    private final static QName _ZaglavljeMT102_QNAME = new QName("http://paket/mt102", "zaglavljeMT102");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: paket.mt102
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://paket/mt102", name = "pojedinacnoPlacanjeMT102")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://paket/mt102", name = "zaglavljeMT102")
