...
insert into Racun(broj_racuna, firma_id, banka_id, obracunski, valuta , novo_stanje, rezervisana_sredstva) values ('123-1231231231231-23', null, 1, true, 'rsd', 0 , 0);
insert into Racun(broj_racuna, firma_id, banka_id, obracunski, valuta , novo_stanje, rezervisana_sredstva) values ('124-1241241241241-24', null, 2, true, 'rsd', 0 , 0);
...
insert into Racun(broj_racuna, firma_id, banka_id, obracunski, valuta , novo_stanje, rezervisana_sredstva) values ('123-1111111111111-1', 1, 1, true, 'rsd', 50000, 0);
insert into Racun(broj_racuna, firma_id, banka_id, obracunski, valuta , novo_stanje, rezervisana_sredstva) values ('124-2222222222222-2', 2, 2, true, 'rsd', 50000, 0);
